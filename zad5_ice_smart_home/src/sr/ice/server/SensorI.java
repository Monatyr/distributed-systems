...
public class SensorI implements Devices.Sensor {
    ...
    public float getTemp(Current current) {
        ...
        System.out.println(current.id.category + "/" + current.id.name + " - get temperature: " + temperatures.get(current.id.name));
    ...
    public float getLuminousIntensity(Current current) {
        makeMeasurements(current);
        System.out.println(current.id.category + "/" + current.id.name + " - get luminous intensity: " + luminousIntensities.get(current.id.name));
        return  luminousIntensities.get(current.id.name);
    }

    @Override
    public void makeMeasurements(Current current) {
        System.out.println(current.id.category + "/" + current.id.name + " - making measurements");
    ...
    public Map<String, Float> getAllMeasurements(Current current) {
        ...
        System.out.print(current.id.category + "/" + current.id.name + " - sending measurements -");
